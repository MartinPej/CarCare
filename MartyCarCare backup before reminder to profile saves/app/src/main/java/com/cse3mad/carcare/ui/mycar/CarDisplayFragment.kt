...
class CarDisplayFragment : Fragment() {
    ...
    private fun showDatePicker() {
        ...
        DatePickerDialog(
            ...
            { _, selectedYear, selectedMonth, selectedDay ->
                ...
                MaintenancePreferences.saveMaintenanceDate(selectedCalendar.timeInMillis)
                updateMaintenanceUI()
            },
            year,
            month,
    ...
    private fun showOilChangeDatePicker() {
        ...
        DatePickerDialog(
            ...
            { _, selectedYear, selectedMonth, selectedDay ->
                ...
                MaintenancePreferences.saveOilChangeDate(selectedCalendar.timeInMillis)
                updateOilChangeUI()
            },
            year,
            month,
    ...
    private fun updateMaintenanceUI() {
        if (MaintenancePreferences.hasMaintenanceDate()) {
            // Hide the add reminder button
            binding.addReminderButton.visibility = View.GONE
            
            // Show the countdown text
            val daysUntil = MaintenancePreferences.getDaysUntilMaintenance()
            val countdownText = when {
                ...
                daysUntil == 0 -> "Your car maintenance is due today!"
                    ...
                    MaintenancePreferences.clearMaintenanceDate()
    ...
    private fun updateOilChangeUI() {
        if (MaintenancePreferences.hasOilChangeDate()) {
            // Hide the add reminder button
            binding.addOilChangeReminderButton.visibility = View.GONE
            
            // Show the countdown text
            val daysUntil = MaintenancePreferences.getDaysUntilOilChange()
            val countdownText = when {
                ...
                daysUntil == 0 -> "Your oil change is due today!"
                    ...
                    MaintenancePreferences.clearOilChangeDate()
